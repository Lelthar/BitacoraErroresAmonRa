...
class ErrorsTest < ApplicationSystemTestCase
  ...
  test "creating a Error" do
    ...
    fill_in "Cause", with: @error.cause
    fill_in "Code", with: @error.code
    fill_in "Message", with: @error.message
    fill_in "Reference", with: @error.reference
    fill_in "Solution", with: @error.solution
    fill_in "Users", with: @error.users_id
